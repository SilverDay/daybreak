...
$isCreate = ($source === null);
$s = $source ?? [
    'id' => null, 'name' => '', 'slug' => '', 'homepage_url' => '', 'feed_url' => '',
    'adapter_type' => 'rss_atom', 'category_id' => null, 'attribution_text' => '',
    'license' => '', 'fetch_interval_min' => 15, 'field_map' => '', 'status' => 'pending',
...
<div class="settings-page settings-page--wide">
  ...
  <form method="post" action="<?= $isCreate ? '/admin/sources/create' : '/admin/sources/' . (int) $s['id'] ?>">
      ...
      <div class="form-row-2">
        <div class="form-group">
          ...
          <select id="src-adapter" class="form-input" name="adapter_type">
            <?php foreach (['rss_atom', 'json_api', 'ransomlook', 'nvd', 'html_scrape'] as $a): ?>
    ...
    <div class="form-actions">
      <button type="submit" class="btn btn-primary"><?= $isCreate ? 'Create source' : 'Save changes' ?></button>
