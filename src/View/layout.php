    ...
    <div class="site-header-inner">
      ...
      <nav class="site-nav" aria-label="User navigation">
        <?php if ($_currentUser): ?>
          ...
          <a href="/starred" class="site-nav-link<?= ($activeNav ?? '') === 'starred' ? ' site-nav-link--active' : '' ?>">Starred</a>
          <a href="/public" class="site-nav-link<?= ($activeNav ?? '') === 'public' ? ' site-nav-link--active' : '' ?>">All</a>
